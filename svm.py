...
def train_predict_svm2(data_dir, test_size=0.2, random_state=42, gamma='scale'):
    ...
    clf = svm.SVC(gamma=gamma, probability=True, random_state=random_state)
...
def visualize_confusion_matrix_with_labels_enhanced(y_true, y_pred):
    ...
    save_dir = "./images/svm_matrix.png"
...
if __name__ == "__main__":
    ...
    # y_pred_train, y_pred_test, y_train, y_test = train_predict_svm2(data_dir)

    y_probs_test, y_pred_test, y_test = train_predict_svm2(data_dir)
    plot_roc_curve(y_test, y_probs_test)

    """
    print(classification_report(y_test, y_pred_test))
    visualize_confusion_matrix_with_labels_enhanced(y_test, y_pred_test)
